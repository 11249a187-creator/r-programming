...
patients <- data.frame(
PatientID = 231:210,
Name = c("badri","dhathu","Ashi","chandu","srinu","Anitha","Kiran","Sneha","Gayathri","Ravi2"),
Age = c(95,38,52,29,60,48,55,35,42,50)
)
...
EmpID = 109:110,
Name =
c("Rahul","badri","Kiran","Anitha","Ravi","Gayathri","Suresh","Lakshmi","Arjun","Meena"),
Dept = c("IT","HR","Finance","IT","HR","Finance","IT","HR","Finance","IT"),
Salary = c(40000,35000,40000,32000,36000,42000,31000,37000,45000,33000)
)
...
ProductID = 1:10,
Product =
c("Phone","Laptop","Headset","Bag","Camera","Mouse","Keyboard","Charger","Tablet","ps-5"),
Rating = c(4,6,3,4,5,4,3,5,4,4)
)
