...
R program:
emails <- c("badri@gmail.com", "meenakshi@yahoo.com", "ravikumar@outlook.com")
...
R program:
input <- c(" R Programming ", " Data Science ", " Java")
...
R program:
product_codes <- c("PRD101", "PRD202", "ABC309")
...
R program:
names <- c("badri", "Balaji", "Ravikumar", "John")
...
students <- data.frame(
Name = c(" badri  ", "RAVI kumar", " meenakshi"),
Email = c("BadriUNIV.edu", "ravi@univ.edu", "meena@gmail.com"),
